...
## Latest release: v2.7.82

Download from the [v2.7.82 release page](https://github.com/jalijaak/MemoryScreenSaverPlusX_Release/releases/tag/v2.7.82):

| Platform | File |
|----------|------|
| MemoryScreenSaverPlus-Setup-v2.7.82-win-x64.exe | [MemoryScreenSaverPlus-Setup-v2.7.82-win-x64.exe](https://github.com/jalijaak/MemoryScreenSaverPlusX_Release/releases/download/v2.7.82/MemoryScreenSaverPlus-Setup-v2.7.82-win-x64.exe) |
| MemoryScreenSaverPlus-v2.7.82-macos-x64.tar.gz | [MemoryScreenSaverPlus-v2.7.82-macos-x64.tar.gz](https://github.com/jalijaak/MemoryScreenSaverPlusX_Release/releases/download/v2.7.82/MemoryScreenSaverPlus-v2.7.82-macos-x64.tar.gz) |
| MemoryScreenSaverPlus-v2.7.82-macos-arm64.tar.gz | [MemoryScreenSaverPlus-v2.7.82-macos-arm64.tar.gz](https://github.com/jalijaak/MemoryScreenSaverPlusX_Release/releases/download/v2.7.82/MemoryScreenSaverPlus-v2.7.82-macos-arm64.tar.gz) |

Release notes: [release-notes/v2.7.82.md](release-notes/v2.7.82.md)
