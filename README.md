...
## Latest release: v2.7.78

Download from the [v2.7.78 release page](https://github.com/jalijaak/MemoryScreenSaverPlusX_Release/releases/tag/v2.7.78):

| Platform | File |
|----------|------|
| MemoryScreenSaverPlus-Setup-v2.7.78-win-x64.exe | [MemoryScreenSaverPlus-Setup-v2.7.78-win-x64.exe](https://github.com/jalijaak/MemoryScreenSaverPlusX_Release/releases/download/v2.7.78/MemoryScreenSaverPlus-Setup-v2.7.78-win-x64.exe) |
| MemoryScreenSaverPlus-v2.7.78-macos-x64.tar.gz | [MemoryScreenSaverPlus-v2.7.78-macos-x64.tar.gz](https://github.com/jalijaak/MemoryScreenSaverPlusX_Release/releases/download/v2.7.78/MemoryScreenSaverPlus-v2.7.78-macos-x64.tar.gz) |
| MemoryScreenSaverPlus-v2.7.78-macos-arm64.tar.gz | [MemoryScreenSaverPlus-v2.7.78-macos-arm64.tar.gz](https://github.com/jalijaak/MemoryScreenSaverPlusX_Release/releases/download/v2.7.78/MemoryScreenSaverPlus-v2.7.78-macos-arm64.tar.gz) |

Release notes: [release-notes/v2.7.78.md](release-notes/v2.7.78.md)
