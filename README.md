...
## Latest release: v2.6.88

Download from the [v2.6.88 release page](https://github.com/jalijaak/MemoryScreenSaverPlusX_Release/releases/tag/v2.6.88):

| Platform | File |
|----------|------|
| MemoryScreenSaverPlus-Setup-v2.6.88-win-x64.exe | [MemoryScreenSaverPlus-Setup-v2.6.88-win-x64.exe](https://github.com/jalijaak/MemoryScreenSaverPlusX_Release/releases/download/v2.6.88/MemoryScreenSaverPlus-Setup-v2.6.88-win-x64.exe) |
| MemoryScreenSaverPlus-v2.6.88-macos-x64.tar.gz | [MemoryScreenSaverPlus-v2.6.88-macos-x64.tar.gz](https://github.com/jalijaak/MemoryScreenSaverPlusX_Release/releases/download/v2.6.88/MemoryScreenSaverPlus-v2.6.88-macos-x64.tar.gz) |
| MemoryScreenSaverPlus-v2.6.88-macos-arm64.tar.gz | [MemoryScreenSaverPlus-v2.6.88-macos-arm64.tar.gz](https://github.com/jalijaak/MemoryScreenSaverPlusX_Release/releases/download/v2.6.88/MemoryScreenSaverPlus-v2.6.88-macos-arm64.tar.gz) |

Release notes: [release-notes/v2.6.88.md](release-notes/v2.6.88.md)
