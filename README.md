...
## Latest release: v2.8.41

Download from the [v2.8.41 release page](https://github.com/jalijaak/MemoryScreenSaverPlusX_Release/releases/tag/v2.8.41):

| Platform | File |
|----------|------|
| MemoryScreenSaverPlus-Setup-v2.8.41-win-x64.exe | [MemoryScreenSaverPlus-Setup-v2.8.41-win-x64.exe](https://github.com/jalijaak/MemoryScreenSaverPlusX_Release/releases/download/v2.8.41/MemoryScreenSaverPlus-Setup-v2.8.41-win-x64.exe) |
| MemoryScreenSaverPlus-v2.8.41-macos-x64.tar.gz | [MemoryScreenSaverPlus-v2.8.41-macos-x64.tar.gz](https://github.com/jalijaak/MemoryScreenSaverPlusX_Release/releases/download/v2.8.41/MemoryScreenSaverPlus-v2.8.41-macos-x64.tar.gz) |
| MemoryScreenSaverPlus-v2.8.41-macos-arm64.tar.gz | [MemoryScreenSaverPlus-v2.8.41-macos-arm64.tar.gz](https://github.com/jalijaak/MemoryScreenSaverPlusX_Release/releases/download/v2.8.41/MemoryScreenSaverPlus-v2.8.41-macos-arm64.tar.gz) |

Release notes: [release-notes/v2.8.41.md](release-notes/v2.8.41.md)
