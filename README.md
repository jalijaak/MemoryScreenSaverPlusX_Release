...
## Latest release: v2.8.16

Download from the [v2.8.16 release page](https://github.com/jalijaak/MemoryScreenSaverPlusX_Release/releases/tag/v2.8.16):

| Platform | File |
|----------|------|
| MemoryScreenSaverPlus-Setup-v2.8.16-win-x64.exe | [MemoryScreenSaverPlus-Setup-v2.8.16-win-x64.exe](https://github.com/jalijaak/MemoryScreenSaverPlusX_Release/releases/download/v2.8.16/MemoryScreenSaverPlus-Setup-v2.8.16-win-x64.exe) |
| MemoryScreenSaverPlus-v2.8.16-macos-x64.tar.gz | [MemoryScreenSaverPlus-v2.8.16-macos-x64.tar.gz](https://github.com/jalijaak/MemoryScreenSaverPlusX_Release/releases/download/v2.8.16/MemoryScreenSaverPlus-v2.8.16-macos-x64.tar.gz) |
| MemoryScreenSaverPlus-v2.8.16-macos-arm64.tar.gz | [MemoryScreenSaverPlus-v2.8.16-macos-arm64.tar.gz](https://github.com/jalijaak/MemoryScreenSaverPlusX_Release/releases/download/v2.8.16/MemoryScreenSaverPlus-v2.8.16-macos-arm64.tar.gz) |

Release notes: [release-notes/v2.8.16.md](release-notes/v2.8.16.md)
