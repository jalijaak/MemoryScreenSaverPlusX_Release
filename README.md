...
## Latest release: v2.8.06

Download from the [v2.8.06 release page](https://github.com/jalijaak/MemoryScreenSaverPlusX_Release/releases/tag/v2.8.06):

| Platform | File |
|----------|------|
| MemoryScreenSaverPlus-Setup-v2.8.06-win-x64.exe | [MemoryScreenSaverPlus-Setup-v2.8.06-win-x64.exe](https://github.com/jalijaak/MemoryScreenSaverPlusX_Release/releases/download/v2.8.06/MemoryScreenSaverPlus-Setup-v2.8.06-win-x64.exe) |
| MemoryScreenSaverPlus-v2.8.06-macos-x64.tar.gz | [MemoryScreenSaverPlus-v2.8.06-macos-x64.tar.gz](https://github.com/jalijaak/MemoryScreenSaverPlusX_Release/releases/download/v2.8.06/MemoryScreenSaverPlus-v2.8.06-macos-x64.tar.gz) |
| MemoryScreenSaverPlus-v2.8.06-macos-arm64.tar.gz | [MemoryScreenSaverPlus-v2.8.06-macos-arm64.tar.gz](https://github.com/jalijaak/MemoryScreenSaverPlusX_Release/releases/download/v2.8.06/MemoryScreenSaverPlus-v2.8.06-macos-arm64.tar.gz) |

Release notes: [release-notes/v2.8.06.md](release-notes/v2.8.06.md)
